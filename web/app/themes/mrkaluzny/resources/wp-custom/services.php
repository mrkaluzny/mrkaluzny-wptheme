...
function services_post_type() {
	$labels = array(
		...
		'singular_name'         => _x( 'Services Item', 'Post Type Singular Name', 'mrkaluzny' ),
		'menu_name'             => __( 'Services', 'mrkaluzny' ),
		'name_admin_bar'        => __( 'Services', 'mrkaluzny' ),
		'archives'              => __( 'Services Item Archives', 'mrkaluzny' ),
		'attributes'            => __( 'Services Item Attributes', 'mrkaluzny' ),
		'parent_item_colon'     => __( 'Parent Services Item:', 'mrkaluzny' ),
		'all_items'             => __( 'All Services', 'mrkaluzny' ),
		'add_new_item'          => __( 'Add New Services Item', 'mrkaluzny' ),
		'add_new'               => __( 'Add New Services Item', 'mrkaluzny' ),
		'new_item'              => __( 'New Services Item', 'mrkaluzny' ),
		'edit_item'             => __( 'Edit Services Item', 'mrkaluzny' ),
		'update_item'           => __( 'Update Services Item', 'mrkaluzny' ),
		'view_item'             => __( 'View Services Item', 'mrkaluzny' ),
	...
	$args = array(
		'label'                 => __( 'Services Item', 'mrkaluzny' ),
